...
help:
	@echo "make help | clean | all | aStarTests | biDirectionalTests | interpretationTests | shrdlite-html.js | shrdlite-offline.js"
...
biDirectionalTests: TestBiDirectional.js
	node $< all
